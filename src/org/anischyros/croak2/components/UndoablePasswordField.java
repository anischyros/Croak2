...
// This is essentially a JPasswordField that supports undo/redo, both via the
...
public class UndoablePasswordField extends JTextField
{
    private UndoManager undoManager;
    
    public UndoablePasswordField()
    {
        super();
        configureUndoSupport();
    }
    
    public UndoablePasswordField(Document doc, String text, int columns)
    {
        super(doc, text, columns);
        configureUndoSupport();
    }
    
    public UndoablePasswordField(int columns)
    {
        super(columns);
        configureUndoSupport();
    }
    
    public UndoablePasswordField(String text)
    {
        super(text);
        configureUndoSupport();
    }
    
    public UndoablePasswordField(String text, int columns)
    {
        super(text, columns);
        configureUndoSupport();
    }
